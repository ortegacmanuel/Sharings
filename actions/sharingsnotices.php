 ...
 */
class SharingsNoticesAction extends Action
{
    ...
    function title()
    {
            return _m('Objetos y servicios compartidos en la red');
    }
